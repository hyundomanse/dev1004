				...
				<table class="tbl cell">
					...
					<tbody>
						...
						<tr>
							<th>등록자</th>
							<td align="left">
								<input type="text" id="searchCreateId" name="searchCreateId" value="${adminAuthMap.createId}" disabled="disabled"/>
							</td>
							
							<th>등록일자</th>
							<td align="left">
								<input type="text" id="searchCreateDt" name="searchCreateDt" value="${adminAuthMap.createDt}" disabled="disabled"/>
							</td>							
						</tr>
