			...
			success : function(data) {
				...
				if(rtnList != null && rtnList.length > 0) {
					for(var i=0; i<rtnList.length; i++) {
						...
						+"<td onclick=\"javascript:fn_view('"+rtnList[i].codeSeq+"');\">"+ rtnList[i].createId +"</td>"
	               		+"<td onclick=\"javascript:fn_view('"+rtnList[i].codeSeq+"');\">"+ rtnList[i].createDt +"</td>"
	               		+"<td onclick=\"javascript:fn_view('"+rtnList[i].codeSeq+"');\">"+ rtnList[i].modifyId +"</td>"
	               		+"<td onclick=\"javascript:fn_view('"+rtnList[i].codeSeq+"');\">"+ rtnList[i].modifyDt +"</td>"
